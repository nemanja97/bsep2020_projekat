...
public interface LogsRepository extends MongoRepository<Log, Long>, QuerydslPredicateExecutor<Log> {
    ...
    @Aggregation(pipeline={"{$project: {\n" +
            ...
            "  sysCount: '$sysCount',\n" +
            "}}"})
    List<ReportData> findLogsMonthlyCount(String startDate, String endDate);
    ...
    @Aggregation(pipeline={"{$project: {\n" +
            ...
            "  sysCount: '$sysCount',\n" +
            "}}"})
    List<ReportData> findLogsWeeklyCount(String startDate, String endDate);
    ...
    @Aggregation(pipeline={"" +
            ...
            "  sysCount: '$sysCount',\n" +
            "}}"})
    List<ReportData> findLogsDailyCount(String startDate, String endDate);
    ...
    @Aggregation(pipeline={"" +
            ...
            "\n" +
            "  }}"})
    List<ReportData> findLogsTotalCountByType(String startDate, String endDate);
    ...
    @Aggregation(pipeline={"{$project: {\n" +
            ...
            "  count: '$count'\n" +
            "}}"})
    List<ReportData> findLogsTotalCountByHostname(String startDate, String endDate);
