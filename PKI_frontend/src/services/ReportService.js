...
async function getAlarmsMonthlyCount(query) {
    ...
    return await axios.get(
        `${process.env.REACT_APP_PKI_API_URL}/v1/reports/alarms/monthly/type?${url_query}`
    );
}
...
async function getAlarmsWeeklyCount(query) {
    const url_query = QueryService.formQuery(query);
    return await axios.get(
        `${process.env.REACT_APP_PKI_API_URL}/v1/reports/alarms/weekly/type?${url_query}`
    );
}
...
async function getAlarmsDailyCount(query) {
    const url_query = QueryService.formQuery(query);
    return await axios.get(
        `${process.env.REACT_APP_PKI_API_URL}/v1/reports/alarms/daily/type?${url_query}`
    );
}
...
async function getAlarmsTotalCountByType(query) {
    const url_query = QueryService.formQuery(query);
    return await axios.get(
        `${process.env.REACT_APP_PKI_API_URL}/v1/reports/alarms/total/type?${url_query}`
    );
}
...
async function getAlarmsTotalCountByHostname(query) {
    const url_query = QueryService.formQuery(query);
    return await axios.get(
        `${process.env.REACT_APP_PKI_API_URL}/v1/reports/alarms/total/hostname?${url_query}`
    );
}
...
async function getLogsMonthlyCount(query) {
    const url_query = QueryService.formQuery(query);
    return await axios.get(
        `${process.env.REACT_APP_PKI_API_URL}/v1/reports/logs/monthly/type?${url_query}`
    );
}
...
async function getLogsWeeklyCount(query) {
    const url_query = QueryService.formQuery(query);
    return await axios.get(
        `${process.env.REACT_APP_PKI_API_URL}/v1/reports/logs/weekly/type?${url_query}`
    );
}
...
async function getLogsDailyCount(query) {
    const url_query = QueryService.formQuery(query);
    return await axios.get(
        `${process.env.REACT_APP_PKI_API_URL}/v1/reports/logs/daily/type?${url_query}`
    );
}
...
async function getLogsTotalCountByType(query) {
    const url_query = QueryService.formQuery(query);
    return await axios.get(
        `${process.env.REACT_APP_PKI_API_URL}/v1/reports/logs/total/type?${url_query}`
    );
}
...
async function getLogsTotalCountByHostname(query) {
    const url_query = QueryService.formQuery(query);
    return await axios.get(
        `${process.env.REACT_APP_PKI_API_URL}/v1/reports/logs/total/hostname?${url_query}`
    );
}
